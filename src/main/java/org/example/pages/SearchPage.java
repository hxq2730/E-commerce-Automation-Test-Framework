...
public class SearchPage extends CommonPage{
    //---LOCATOR---
    // Locator for the list of product names in the result grid
    private static final By LIST_PRODUCT_NAMES = By.xpath("//div[contains(@class, 'aiz-card-box')]//h3/a");

    // Locator for 'No results found' message (optional)
